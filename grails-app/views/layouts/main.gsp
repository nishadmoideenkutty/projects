...
<head>
  ...
  <link rel="stylesheet" href="${assetPath(src: 'fontawesome-free/css/all.min.css')}">
  <!-- Ionicons -->
...
<script src="${assetPath(src: 'demo.js')}"></script>
 ...
 <script src="${assetPath(src: 'validation.js')}"></script>
    ...
    $("#usrImage").attr('src',"${createLink(controller:'Login', action:'updateImage',id:request.getCookie('ajx_ui'))}");
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link ">
      <img src="${assetPath(src: 'logoKicth.png')}" alt="KitchApp Logo" class="align-middle" />
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img  id="usrImage" src="" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">${request.getCookie('ajx_un')}</a>
        </div>
      </div>
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2 tstr">
          <div class="col-sm-6 ">
            <h1>${frmName?frmName:""}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">${frmName?frmName:""}</a></li>
              <li class="breadcrumb-item active">${ subFrmName?subFrmName:""}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
         ...
         <g:render template="/layouts/progress"/>
        </div>
        <!-- /.card-body -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="http://ajaxconnect.in">Ajax Solutions</a>.</strong> All rights
    reserved.
  </footer>
