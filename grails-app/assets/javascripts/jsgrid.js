        ...
        _createPager: function() {
            ...
            if($.isFunction(this.pagerRenderer)) {
                $result = $(this.pagerRenderer({
                 ...
                 var $tmp=$("<ul class='pagination pagination-sm no-margin pull-right'>").append(this._createPagerByFormat());
                 $result = $("<div class='box-footer clearfix'>").append($tmp);
                 
//                  $result = $("<div>").append(this._createPagerByFormat());
            }
//            $result.removeClass("jsgrid-pager-nav-button");
//            $result.removeClass("jsgrid-pager-nav-inactive-button");
...
//                .text(this.pageIndex);
            var $tg=$("<a class='bg-gray'>").text(this.pageIndex)
            return $("<li>").append($tg);
//                .addClass(this.pageClass)
//                .addClass(this.currentPageClass)
